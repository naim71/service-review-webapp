        ...
        <div>
            <div className="flex items-center flex-col justify-center lg:flex-row py-28 px-6 md:px-24 md:py-20 lg:py-32 gap-16 lg:gap-28">
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <p className="py-2 text-base text-gray-800 mb-8">Sorry about that! Please visit our hompage to get where you need to go.</p>
                    <Link to="/" className="w-full lg:w-auto my-4 border rounded-md px-1 sm:px-16 py-5 bg-emerald-600 text-white hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50 mt-5">Go back to Homepage</Link>
                </div>
            </div>
        </div>
    );
